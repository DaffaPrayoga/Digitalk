...
<div class="uk-container uk-margin-medium-top">
    <div class="headerz" style="margin-top: -20px;">
        <img src="{{asset('img/no_gadget.svg')}}" class="uk-animation-scale-up delay-animation" uk-img style="height: 150px;display: inline-block" alt="">
        <p class="font-heavy grey-text-4 uk-heading-small uk-animation-slide-left" style="display:inline-block;position:relative;top: 15px;left: 10px;animation-delay: 1s">Brands<span
    ...
    <div class="uk-child-width-expand@s uk-text-center uk-margin-medium-top" uk-grid
        ...
        @forelse($brands as $b)
            <div class="uk-width-1-5">
                <div
                    class="uk-card uk-card-default hoverable uk-card-body uk-border-rounded uk-padding-small z-depth-15"
        ...
        @empty
            <div class="uk-text-center">
                ...
                <p class="grey-text-1 font-regular" style="font-size: 17px;margin-top: -15px;">no brand that has been registered by the admin.</p>
            </div>
        @endforelse
    </div>
</div>
